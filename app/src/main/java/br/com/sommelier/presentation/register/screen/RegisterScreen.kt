...
fun RegisterStringResource.toText(): String {
    return when (this) {
        is RegisterStringResource.Empty -> emptyString()
        is RegisterStringResource.BlankName -> stringResource(id = R.string.blank_name_message)
        is RegisterStringResource.InvalidName -> stringResource(id = R.string.invalid_name_message)
        is RegisterStringResource.BlankEmail -> stringResource(id = R.string.blank_email_message)
        is RegisterStringResource.InvalidEmail -> stringResource(id = R.string.invalid_email_message)
        is RegisterStringResource.BlankPassword -> stringResource(id = R.string.blank_password_message)
        is RegisterStringResource.InvalidPassword -> stringResource(id = R.string.invalid_password_message)
        is RegisterStringResource.BlankPasswordConfirmation -> stringResource(id = R.string.blank_password_confirmation_message)
        is RegisterStringResource.PasswordConfirmationNotMatch -> stringResource(id = R.string.password_confirmation_not_match_message)
    }
}
